...
export const NoteLIst = ({availableTags, notes, onDeleteTag, onUpdateTag } : NoteLIst) => {
     ...
     <Row className="align-items-center mb-4" >
        ...
        <Col xs='auto' >
          <Stack gap={2} direction="horizontal" >
            ...
            <Button onClick={() => setEditTagsModelIsOpen(true)} variant="outline-secondary" >Edit Tags</Button>
          </Stack>
        </Col>
     </Row>
     <Form className="mb-4" >
...
const NoteCart = ({id, title, tags}:SimplifiedNotes) => {
 return <Card 
         as={Link} 
         to={`/${id}`} 
...
const EditTagsModal = ({availableTags, handleClose, show, onDeleteTag, onUpdateTag } : EditTagsModal ) => {
